...
# Output directory
# baseOutDir = 'results/SingleEleSingleEGL1_DoubleEleRefAlt_vs_Probe_Eta'
baseOutDir = 'results/SingleEleSingleEGL1_DoubleEleRefAlt_vs_Probe_Eta_nobins'
...
biningDef = [
    ...
    { 'var' : 'JpsiKE_e2_eta', 'type': 'float', 'bins': [-1.22, 1.22] }, # No Binning
]
