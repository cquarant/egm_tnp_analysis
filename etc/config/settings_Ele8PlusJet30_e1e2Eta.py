...
# Output directory
baseOutDir = 'results/EffBothLegs_vs_e1e2Eta_ElePlusJet'
...
refEffFile = '/afs/cern.ch/work/c/cquarant/RKanalysis/CMSSW_10_6_29/src/egm_tnp_analysis/results/RefEff_vs_Probe_Eta_ElePlusJet/probe_fired/differential_eff_probe_fired.root'
