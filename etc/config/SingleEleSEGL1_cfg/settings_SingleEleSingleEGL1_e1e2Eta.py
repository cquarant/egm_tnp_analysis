...
# Output directory
baseOutDir = 'results/EffBothLegs_vs_e1e2Eta_SingleEleSingleEGL1'
...
biningDef = [
    # Probe Eta binning
    { 'var' : 'JpsiKE_e1_eta', 'type': 'float', 'bins': [-1.22, -1.0, -0.75, -0.50, -0.25, -0.00, 0.25, 0.50, 0.75, 1.00, 1.22] }, #Nvtx_standard
