...
biningDef = [
    ...
    { 'var' : 'JpsiKE_e1_pt', 'type': 'float', 'bins': [5.0, 9999999.0] }, # Noah binning
...
refEffFile = '/afs/cern.ch/work/c/cquarant/RKanalysis/CMSSW_10_6_29/src/egm_tnp_analysis/results/SingleEleSingleEGL1_RefEff_vs_Probe_Pt_NoahBins/probe_fired/differential_eff_probe_fired.root'
