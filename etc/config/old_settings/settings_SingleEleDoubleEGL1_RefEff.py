...
# Output directory
baseOutDir = 'results/RefEff_vs_Probe_Pt_Ele8Jet30_NoahBins'
...
biningDef = [
    ...
    # Probe Pt binning
    { 'var' : 'JpsiKE_e2_pt', 'type': 'float', 'bins': [5.0, 7.0, 9.0, 10.0, 11.0, 12.0, 13.0, 9999999.0] }, #standard_2022_final
