...
#baseOutDir = 'results/Eff_vs_Probe_Pt_ElePlusJet_specialDRCut'
#baseOutDir = 'results/Eff_vs_Probe_Pt_LowPU_ElePlusJet'
#baseOutDir = 'results/Eff_vs_Probe_Pt_LowPU_ElePlusJet_rebinned'
#baseOutDir = 'results/Eff_vs_Probe_Pt_HighPU_ElePlusJet'
#baseOutDir = 'results/Eff_vs_Probe_Pt_HighPU_ElePlusJet_rebinned'

#baseOutDir = 'results/Eff_vs_elesDr_ElePlusJet'
baseOutDir = 'results/Eff_vs_elesDr_ElePlusJet_specialDRcut'
#baseOutDir = 'results/Eff_vs_elesDr_ElePlusJet_rebinned'
...
biningDef = [
    ...
    # { 'var' : 'JpsiKE_e2_pt', 'type': 'float', 'bins': [5.0, 7.0, 9.0, 13.0, 9999999.0] }, #rebinned_2022_final 
    ...
    { 'var' : 'JpsiKE_elesDr', 'type': 'float', 'bins': [0.0, 0.25, 0.35, 0.6, 0.9] }, #elesDr_standard
...
tnpParNomFitJPsi = [
    ...
    "meanP[3.096, 3.0, 3.2]","sigmaP[0.055, 0.04, 0.07]" , "alphaLP[0.5, 0.2, 0.7]" , "alphaRP[0.9, 0.8, 1.5]" , "nLP[14, 10, 16]","nRP[5, 4, 8]",
    "meanF[3.096, 3.0, 3.15]","sigmaF[0.055, 0.04, 0.07]" , "alphaLF[0.6, 0.5, 0.7]" , "alphaRF[1.0, 0.8, 1.2]" , "nLF[14, 10, 16]","nRF[5, 4, 8]",
    "expalphaP[-0.7, -1.0, 0]",
