...
baseOutDir = 'results/HLTeff_vs_Probe_Pt_SingleEleDieleEGL1'
#baseOutDir = 'results/Eff_vs_elesDr_SingleEleDieleEGL1_specialDRCut'
#baseOutDir = 'results/Eff_vs_elesDr_SingleEleDieleEGL1_rebinned'
...
biningDef = [
    ...
    # { 'var' : 'JpsiKE_elesDr', 'type': 'float', 'bins': [0.0, 0.25, 0.35, 0.6] }, #elesDr_standard
    # { 'var' : 'JpsiKE_elesDr', 'type': 'float', 'bins': [0.0, 0.15, 0.2, 0.25, 0.3, 0.35, 0.6, 0.7] }, #elesDr_rebinned
...
tnpParNomFitJPsi = [
    ...
    # "meanP[3.096, 3.0, 3.2]","sigmaP[0.045, 0.04, 0.06]" , "alphaLP[0.5, 0.2, 0.7]" , "alphaRP[0.9, 0.8, 1.5]" , "nLP[14, 10, 16]","nRP[5, 4, 8]",
    # "meanF[3.096, 3.0, 3.1]","sigmaF[0.045, 0.04, 0.06]" , "alphaLF[0.6, 0.5, 0.7]" , "alphaRF[1.0, 0.8, 1.2]" , "nLF[14, 10, 16]","nRF[5, 4, 8]",
