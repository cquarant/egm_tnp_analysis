...
# Output directory
# baseOutDir = 'results/RefEff_vs_Nvtx_SingleEleSingleEGL1'
baseOutDir = 'results/RefEff_vs_Nvtx_MC_NoahBins'
# baseOutDir = 'results/RefEff_vs_Nvtx_SingleEleSingleEGL1_NoBins'
...
cutBase = 'SingleEle_fired==1 && JpsiKE_e1_istag==1 && JpsiKE_Jpsi_mass_nofit>2.10001 && JpsiKE_Jpsi_mass_nofit<3.61 && abs(JpsiKE_e1_eta)<1.22 & abs(JpsiKE_e2_eta)<1.22 & JpsiKE_e1_pt>4.0 & JpsiKE_e2_pt>4.0 & JpsiKE_e1_passMVA==1 & JpsiKE_e2_passMVA==1'
...
tnpParNomFitJPsi = [
    ...
    # "meanP[3.096, 3.0, 3.15]","sigmaP[0.055, 0.045, 0.75]" , "alphaLP[0.5, 0.2, 0.7]" , "alphaRP[0.9, 0.8, 1.5]" , "nLP[14, 10, 16]","nRP[5, 4, 8]",
    # "meanF[3.096, 3.0, 3.15]","sigmaF[0.055, 0.045, 0.75]" , "alphaLF[0.6, 0.5, 0.7]" , "alphaRF[1.0, 0.8, 1.2]" , "nLF[14, 10, 16]","nRF[5, 4, 8]",
    # "expalphaP[-0.46, -2.0, 0]",
    # "expalphaF[-0.55, -2.0, 0]",   
