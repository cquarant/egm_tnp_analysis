...
# baseOutDir = 'results/RefEff_vs_Probe_Eta_SingleEleSingleEGL1_NoahBins'
baseOutDir = 'results/RefEff_vs_ProbeEta_DoubleEleFired_SingleEleSingleEGL1_NoBins_test'
...
specialCut = {
    'probe_fired': ' & DoubleEle4p5_fired==1 && (  JpsiKE_e1_Ele4p5_match==1 && JpsiKE_e2_Ele4p5_match==1 )  && JpsiKE_e1_bestL1pt>4.5 && JpsiKE_e2_bestL1pt > 4.5 & JpsiKE_e1_bestL1pt>0 & JpsiKE_e2_bestL1pt>0 & abs(JpsiKE_e1_bestL1eta-JpsiKE_e2_bestL1eta)>0.001 & abs(JpsiKE_e1_bestL1phi-JpsiKE_e2_bestL1phi)>0.001',
}
