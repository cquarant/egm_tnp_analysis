...
# Output directory
# baseOutDir = 'results/RefEff_eprb_vs_Probe_Pt_MC_NoahBins'
# baseOutDir = 'results/RefEff_eprb_vs_Probe_Pt_MC_NoBins'
baseOutDir = 'results/RefEff_eprb_vs_Probe_Pt_MC_NoahBins_cutPt10'
