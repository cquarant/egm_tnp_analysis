...
# Output directory
# baseOutDir = 'results/RefEff_etag_vs_Tag_Pt_MC_NoahBins'
baseOutDir = 'results/RefEff_etag_vs_Tag_Pt_MC_NoBins'
...
biningDef = [
    ...
    # { 'var' : 'JpsiKE_e1_pt', 'type': 'float', 'bins': [5.0, 7.0, 9.0, 10.0, 11.0, 12.0, 13.0, 9999999.0] }, # Noah Bins
    { 'var' : 'JpsiKE_e1_pt', 'type': 'float', 'bins': [5.0, 9999999.0] }, # No Binning
]
...
cutBase =   ('JpsiKE_Jpsi_mass_nofit>2.10001 && JpsiKE_Jpsi_mass_nofit<3.61'
             ...
             ' & JpsiKE_e1_pt>10.0 & JpsiKE_e2_pt>5.0 & JpsiKE_e1_passMVA==1 & JpsiKE_e2_passMVA==1' # for binned study
            )
