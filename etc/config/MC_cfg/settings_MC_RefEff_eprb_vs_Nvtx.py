...
# Output directory
# baseOutDir = 'results/RefEff_eprb_vs_Nvtx_MC_NoahBins'
# baseOutDir = 'results/RefEff_eprb_vs_Nvtx_MC_NoBins'
baseOutDir = 'results/RefEff_eprb_vs_Nvtx_MC_NoahBins_cutPt10'
