...
# Output directory
# baseOutDir = 'results/EffBothLegs_vs_Nvtx_MC'
baseOutDir = 'results/EffBothLegs_vs_Nvtx_MC_NoahBins'
...
samplesDef = {
    ...
    # 'data' : tnpSamples.Parking_doubleEle_run3['BuToKJpsi_Noah'].clone(),
    # 'data' : tnpSamples.Parking_doubleEle_run3['BuToKJpsi_preEE_noSingleEle8'].clone(),
    # 'data' : tnpSamples.Parking_doubleEle_run3['BuToKJpsi_postEE_noSingleEle8'].clone(),
...
# refEffFile = '/afs/cern.ch/work/c/cquarant/RKanalysis/CMSSW_10_6_29/src/egm_tnp_analysis/results/RefEff_vs_Nvtx_SingleEleSingleEGL1/probe_fired/differential_eff_probe_fired.root'
