...
# Output directory
baseOutDir = 'results/EffBothLegs_vs_e2Pt_MC_NoahBins'
...
# reqiring SingleEle fired + matched
# cutBase = 'SingleEle_fired==1 && JpsiKE_e1_istag==1 && JpsiKE_Jpsi_mass_nofit>2.10001 && JpsiKE_Jpsi_mass_nofit<3.61 && abs(JpsiKE_e1_eta)<1.22 & abs(JpsiKE_e2_eta)<1.22 & JpsiKE_e1_pt>5.0 & JpsiKE_e2_pt>5.0 & JpsiKE_e1_passMVA==1'
