...
# flag to be Tested
singleEle_fired = 'SingleEle_fired == 1 && JpsiKE_e1_istag==1'

# flag to be Tested
flags = {
    'singleEle_fired': singleEle_fired,
    }

# Output directory
baseOutDir = 'results/RefEff_etag_vs_Nvtx_MC_NoahBins'
# baseOutDir = 'results/RefEff_etag_vs_Nvtx_MC_NoBins'
