...
for flag in flaglist:
    ...
    os.system("mkdir -p /afs/cern.ch/user/c/cquarant/www/DoubleEleTriggerStudy/tnpPlots/"+data_tag+"_24Oct2022/"+flag)
    os.system("cp /afs/cern.ch/user/c/cquarant/www/index.php /afs/cern.ch/user/c/cquarant/www/DoubleEleTriggerStudy/tnpPlots/"+data_tag+"_24Oct2022/"+flag)
    os.system("cp results/doubleEleFired_24Oct2022/"+flag+"/plots/"+data_tag+"/nominalFit/bin*.png /afs/cern.ch/user/c/cquarant/www/DoubleEleTriggerStudy/tnpPlots/"+data_tag+"_24Oct2022/"+flag)
